...
/* Definitions for driver RAYTI */
#define XPAR_XRAYTI_NUM_INSTANCES 1

/* Definitions for peripheral RAYTI_0 */
#define XPAR_RAYTI_0_DEVICE_ID 0
#define XPAR_RAYTI_0_S_AXI_RET_BUNDLE_BASEADDR 0x40000000
#define XPAR_RAYTI_0_S_AXI_RET_BUNDLE_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral RAYTI_0 */
#define XPAR_XRAYTI_0_DEVICE_ID XPAR_RAYTI_0_DEVICE_ID
#define XPAR_XRAYTI_0_S_AXI_RET_BUNDLE_BASEADDR 0x40000000
#define XPAR_XRAYTI_0_S_AXI_RET_BUNDLE_HIGHADDR 0x4000FFFF
