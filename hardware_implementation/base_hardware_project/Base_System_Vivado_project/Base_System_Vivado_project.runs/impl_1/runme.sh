...
HD_PWD='/run/media/nikolas/Linux_Data/Git_Repos/RayTracing_FPGA/hardware_implementation/base_hardware_project/Base_System_Vivado_project/Base_System_Vivado_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Base_Block_Diagram_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Base_Block_Diagram_wrapper.tcl -notrace
