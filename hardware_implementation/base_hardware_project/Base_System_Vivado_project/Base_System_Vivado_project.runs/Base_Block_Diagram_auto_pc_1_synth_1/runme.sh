...
HD_PWD='/run/media/nikolas/Linux_Data/Git_Repos/RayTracing_FPGA/hardware_implementation/base_hardware_project/Base_System_Vivado_project/Base_System_Vivado_project.runs/Base_Block_Diagram_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Base_Block_Diagram_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Base_Block_Diagram_auto_pc_1.tcl
