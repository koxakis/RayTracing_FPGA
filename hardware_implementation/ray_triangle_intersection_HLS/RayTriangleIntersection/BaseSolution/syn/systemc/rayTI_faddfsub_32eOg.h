...
// ==============================================================
#ifndef __rayTI_faddfsub_32eOg__HH__
#define __rayTI_faddfsub_32eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(rayTI_faddfsub_32eOg) {
    ...
    SC_CTOR(rayTI_faddfsub_32eOg):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
