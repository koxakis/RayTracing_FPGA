...
// ==============================================================
#ifndef __rayTI_fcmp_32ns_3g8j__HH__
#define __rayTI_fcmp_32ns_3g8j__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(rayTI_fcmp_32ns_3g8j) {
    ...
    SC_CTOR(rayTI_fcmp_32ns_3g8j):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
