...
## IP Info
set Vendor      "NKoxenoglou"
set Library     "hls"
set IPName      "rayTI"
set Version     "0.7"
set DisplayName "Ray_Triangle_Intersection"
set Revision    "2010121209"
set Description "Base accelerator for simple first run "
set Device      "zynq"
set AutoFamily  ""
...
set sdx_kernel_name "rayTI"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/run/media/nikolas/Linux_Data/Git_Repos/RayTracing_FPGA/hardware_implementation/ray_triangle_intersection_HLS/RayTriangleIntersection/BaseSolution"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {rayTI_fsub_32ns_3bkb
...
set Interfaces {
    s_axi_ret_bundle {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 ap_return R 0x0 "Data signal of ap_return" {{0 1 ap_return R 0 "Bit 0 to 0 Data signal of ap_return"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 dir_pading W 0x0 "Data signal of dir_pading" {{0 32 dir_pading W 0 "Bit 31 to 0 Data signal of dir_pading"}}} {0x20 dir_x W 0x0 "Data signal of dir_x" {{0 32 dir_x W 0 "Bit 31 to 0 Data signal of dir_x"}}} {0x28 dir_y W 0x0 "Data signal of dir_y" {{0 32 dir_y W 0 "Bit 31 to 0 Data signal of dir_y"}}} {0x30 dir_z W 0x0 "Data signal of dir_z" {{0 32 dir_z W 0 "Bit 31 to 0 Data signal of dir_z"}}} {0x38 orig_pading W 0x0 "Data signal of orig_pading" {{0 32 orig_pading W 0 "Bit 31 to 0 Data signal of orig_pading"}}} {0x40 orig_x W 0x0 "Data signal of orig_x" {{0 32 orig_x W 0 "Bit 31 to 0 Data signal of orig_x"}}} {0x48 orig_y W 0x0 "Data signal of orig_y" {{0 32 orig_y W 0 "Bit 31 to 0 Data signal of orig_y"}}} {0x50 orig_z W 0x0 "Data signal of orig_z" {{0 32 orig_z W 0 "Bit 31 to 0 Data signal of orig_z"}}} {0x58 v0_pading W 0x0 "Data signal of v0_pading" {{0 32 v0_pading W 0 "Bit 31 to 0 Data signal of v0_pading"}}} {0x60 v0_x W 0x0 "Data signal of v0_x" {{0 32 v0_x W 0 "Bit 31 to 0 Data signal of v0_x"}}} {0x68 v0_y W 0x0 "Data signal of v0_y" {{0 32 v0_y W 0 "Bit 31 to 0 Data signal of v0_y"}}} {0x70 v0_z W 0x0 "Data signal of v0_z" {{0 32 v0_z W 0 "Bit 31 to 0 Data signal of v0_z"}}} {0x78 v1_pading W 0x0 "Data signal of v1_pading" {{0 32 v1_pading W 0 "Bit 31 to 0 Data signal of v1_pading"}}} {0x80 v1_x W 0x0 "Data signal of v1_x" {{0 32 v1_x W 0 "Bit 31 to 0 Data signal of v1_x"}}} {0x88 v1_y W 0x0 "Data signal of v1_y" {{0 32 v1_y W 0 "Bit 31 to 0 Data signal of v1_y"}}} {0x90 v1_z W 0x0 "Data signal of v1_z" {{0 32 v1_z W 0 "Bit 31 to 0 Data signal of v1_z"}}} {0x98 v2_pading W 0x0 "Data signal of v2_pading" {{0 32 v2_pading W 0 "Bit 31 to 0 Data signal of v2_pading"}}} {0xa0 v2_x W 0x0 "Data signal of v2_x" {{0 32 v2_x W 0 "Bit 31 to 0 Data signal of v2_x"}}} {0xa8 v2_y W 0x0 "Data signal of v2_y" {{0 32 v2_y W 0 "Bit 31 to 0 Data signal of v2_y"}}} {0xb0 v2_z W 0x0 "Data signal of v2_z" {{0 32 v2_z W 0 "Bit 31 to 0 Data signal of v2_z"}}} {0xb8 t W 0x0 "Data signal of t" {{0 32 t W 0 "Bit 31 to 0 Data signal of t"}}} {0xc0 u W 0x0 "Data signal of u" {{0 32 u W 0 "Bit 31 to 0 Data signal of u"}}} {0xc8 v W 0x0 "Data signal of v" {{0 32 v W 0 "Bit 31 to 0 Data signal of v"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 75 II x}
